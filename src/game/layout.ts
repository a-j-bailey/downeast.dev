...
export const PLACES = {
  ...
  // Land side of the seawall, just left of shack-a (Zoning Radar) facade.
  flagpole: { x: 206, y: LAND_TOP_Y },
...
/** Flagpole on the village street, in front of traps so the silhouette reads. */
